...
CURRENT_DIRECTORY = os.path.realpath(__file__).strip('deploy.py')
...
print('---# Nginx config #---')
with open(os.path.join(CURRENT_DIRECTORY, 'sites-available/SITE_NAME_PLACEHOLDER')) as file:
...
with open(os.path.join(CURRENT_DIRECTORY, f'{SITE_NAME_PLACEHOLDER}.tmp'), 'w') as file:
...
with open(os.path.join(CURRENT_DIRECTORY, 'system/SITE_NAME_PLACEHOLDER.service')) as file:
...
print()
print('---# Socket config #---')
with open(os.path.join(CURRENT_DIRECTORY, 'system/SITE_NAME_PLACEHOLDER.socket')) as file:
